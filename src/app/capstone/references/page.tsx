...
export default function Page() {
  return (
    <div className={"h-full w-full flex flex-col overflow-y-scroll"}>
      <div id="border" className={"flex flex-row justify-between text-center "}>
        <span className={"font-bold text-start"}>Sait PNG:</span> SAIT Catalyst
        Symbol. [Online image]. (n.d.). SAIT Our Brand.
        <Link
          className={"text-blue-600 text-wrap overflow-x-scroll"}
